...
from universedex.core.discord import Modal
...
type Interaction = discord.Interaction["UniverseDexBot"]
...
class Menu[P]:
    ...
    A menu needs an instance of [`Source`][universedex.core.utils.menus.Source] for the pagination, and one or more
    [`Formatter`][universedex.core.utils.menus.Source]s which define how to display the current page. The source and
    ...
    [`init`][universedex.core.utils.menus.Source].
    ...
    *formatters: Formatter[P, discord.ui.Item]
    ...
    def __init__(self, bot: "UniverseDexBot", view: LayoutView, source: Source[P], *formatters: Formatter[P, Any]):
        self.bot = bot
        self.view = view
