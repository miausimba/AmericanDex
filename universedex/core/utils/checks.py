...
type Context = commands.Context["UniverseDexBot"]
...
async def get_user_for_check(bot: "UniverseDexBot", user: discord.abc.User) -> "bool | User":
    """
...
def app_check(func: "CommandsCheck[Context]"):
    ...
    Example
    -------
        from universedex.core.utils.checks import app_check, is_staff
    ...
    async def check(interaction: discord.Interaction["UniverseDexBot"]):
