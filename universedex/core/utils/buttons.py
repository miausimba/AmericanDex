...
class ConfirmChoiceView(View):
    ...
    Parameters
    ----------
    ctx: Interaction[UniverseDexBot] | commands.Context[UniverseDexBot]
    ...
    def __init__(
        self,
        ctx: discord.Interaction["UniverseDexBot"] | commands.Context["UniverseDexBot"],
        ...
        self.interaction_response: discord.Interaction["UniverseDexBot"]
    ...
    async def confirm_button(self, interaction: discord.Interaction["UniverseDexBot"], button: Button):
        for item in self.children:
            item.disabled = True  # type: ignore
    ...
    async def cancel_button(self, interaction: discord.Interaction["UniverseDexBot"], button: Button):
        for item in self.children:
            item.disabled = True  # type: ignore
