...
parsing and validation for various Universedex models.
"""
...
log = logging.getLogger("universedex.core.utils.transformers")
...
class ModelTransformer[T: "Model"](app_commands.Transformer, commands.Converter):
    ...
    **filters: Any
    ...
    async def validate(self, ctx: commands.Context["UniverseDexBot"], item: T):
        """
    ...
    async def get_options(
        self, interaction: discord.Interaction["UniverseDexBot"], value: str
    ...
    async def transform(self, interaction: discord.Interaction["UniverseDexBot"], value: str) -> T:
        if not value:
    ...
    async def convert(self, ctx: commands.Context["UniverseDexBot"], argument: str) -> T:
        try:
...
class BallInstanceTransformer(ModelTransformer[BallInstance]):
    ...
    async def validate(self, ctx: commands.Context["UniverseDexBot"], item: BallInstance):
