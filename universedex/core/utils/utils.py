...
async def is_staff(interaction: discord.Interaction["UniverseDexBot"], *perms: str) -> bool:
    """
    ...
    Parameters
    ----------
    interaction: Interaction[UniverseDexBot]
...
async def inventory_privacy(
    ...
    player: Player
        Universedex Player object of the user whose inventory is being inspected.
