...
class CountryballsViewer(LayoutView):
    ...
    @select_row.select()
    async def selected(self, interaction: discord.Interaction["UniverseDexBot"], select: Select):
...
class CountryballsDuplicateSource(LayoutView):
    ...
    @select_row.select()
    async def callback(self, interaction: discord.Interaction["UniverseDexBot"], select: Select):
