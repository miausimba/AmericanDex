...
async def money(ctx: commands.Context[UniverseDexBot]):
    """
...
@money.command()
@checks.has_permissions("bd_models.view_player")
async def balance(ctx: commands.Context[UniverseDexBot], user: discord.User):
    """
...
async def add(ctx: commands.Context[UniverseDexBot], user: discord.User, amount: int):
    """
...
@money.command()
@checks.has_permissions("bd_models.change_player")
async def remove(ctx: commands.Context[UniverseDexBot], user: discord.User, amount: int):
    """
...
@money.command()
@checks.has_permissions("bd_models.change_player")
async def set(ctx: commands.Context[UniverseDexBot], user: discord.User, amount: int):
    """
