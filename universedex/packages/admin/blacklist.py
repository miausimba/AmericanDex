...
from universedex.core.utils.menus import Menu, ModelSource
...
async def blacklist(ctx: commands.Context[UniverseDexBot]):
    """
...
async def blacklist_add(ctx: commands.Context[UniverseDexBot], user: discord.User, *, reason: str | None = None):
    """
...
async def blacklist_remove(ctx: commands.Context[UniverseDexBot], user: discord.User, *, reason: str | None = None):
    """
...
async def blacklist_info(ctx: commands.Context[UniverseDexBot], user: discord.User):
    """
...
async def blacklist_history(ctx: commands.Context[UniverseDexBot], user_id: str):
    """
...
async def blacklistguild(ctx: commands.Context[UniverseDexBot]):
    """
...
async def blacklist_add_guild(ctx: commands.Context[UniverseDexBot], guild_id: str, *, reason: str):
    """
...
async def blacklist_remove_guild(ctx: commands.Context[UniverseDexBot], guild_id: str, *, reason: str | None = None):
    """
...
@checks.has_permissions("bd_models.view_blacklistedid")
async def blacklist_info_guild(ctx: commands.Context[UniverseDexBot], guild_id: str):
    """
