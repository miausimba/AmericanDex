...
if TYPE_CHECKING:
    ...
    from universedex.packages.trade.cog import Trade as TradeCog
...
async def _build_history_view(
    ctx: commands.Context["UniverseDexBot"], queryset: "QuerySet[Trade]", title: str, admin_url_path: str | None = None
):
    ...
    async def callback(interaction: discord.Interaction["UniverseDexBot"]):
...
@checks.has_permissions("bd_models.view_trade", "bd_models.view_tradeobject")
async def history_user(ctx: commands.Context["UniverseDexBot"], user: discord.User, *, flags: UserTradeHistoryFlags):
    """
...
@checks.has_permissions("bd_models.view_trade", "bd_models.view_tradeobject")
async def history_ball(ctx: commands.Context["UniverseDexBot"], countryball_id: str, *, flags: TradeHistoryFlags):
    """
...
@checks.has_permissions("bd_models.view_trade", "bd_models.view_tradeobject")
async def trade_info(ctx: commands.Context["UniverseDexBot"], trade_id: str):
    """
    ...
    from universedex.packages.trade.history import HistoryView
