...
async def info(ctx: commands.Context[UniverseDexBot]):
    """
...
@info.command()
async def guild(ctx: commands.Context[UniverseDexBot], guild_id: str, days: int = 7):
    """
...
@info.command()
async def user(ctx: commands.Context[UniverseDexBot], user: discord.User, days: int = 7):
    """
