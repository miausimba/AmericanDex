...
from universedex import __version__ as universedex_version
from universedex.core.utils.django import row_count_estimate
...
log = logging.getLogger("universedex.packages.info")
...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction["UniverseDexBot"]):
        """
        ...
        dex_credits = (
            f"This instance is owned {owner_credits} {owner}.\nAn instance of [Universedex]"
            f"({settings.repository}) by El Laggron and maintained by the Universedex Team "
        ...
        embed.description = (
            ...
            f"*Running version **[{universedex_version}]({settings.repository}/releases)***\n"
    ...
    @app_commands.command()
    async def help(self, interaction: discord.Interaction["UniverseDexBot"]):
        """
