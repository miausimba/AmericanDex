...
from universedex.core.utils.enums import DONATION_POLICY_MAP, FRIEND_POLICY_MAP, MENTION_POLICY_MAP, PRIVATE_POLICY_MAP
from universedex.core.utils.enums import TRADE_COOLDOWN_POLICY_MAP as TRADE_POLICY_MAP
from universedex.core.utils.menus import ItemFormatter, ListSource, Menu, dynamic_chunks
...
class Player(commands.GroupCog):
    ...
    async def psettings(self, interaction: discord.Interaction["UniverseDexBot"]):
        """
    ...
    async def friend_add(self, interaction: discord.Interaction["UniverseDexBot"], user: discord.User):
        """
    ...
    async def friend_remove(self, interaction: discord.Interaction["UniverseDexBot"], user: discord.User):
        """
        Remove a friend.
    ...
    async def friend_list(self, interaction: discord.Interaction["UniverseDexBot"]):
        """
    ...
    async def block_add(self, interaction: discord.Interaction["UniverseDexBot"], user: discord.User):
        """
        Block another user.
    ...
    async def block_remove(self, interaction: discord.Interaction["UniverseDexBot"], user: discord.User):
        """
        Unblock a user.
    ...
    async def blocked_list(self, interaction: discord.Interaction["UniverseDexBot"]):
        """
    ...
    async def info(self, interaction: discord.Interaction["UniverseDexBot"]):
        """
