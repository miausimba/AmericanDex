...
from universedex.core.utils.menus import Formatter, Menu, TextFormatter, TextSource
...
class HistoryView(LayoutView):
    def __init__(self, bot: "UniverseDexBot", trade: Trade, *, admin_view: bool = False, timeout: float | None = 180):
