...
async def is_staff(interaction: discord.Interaction["AmericanDexBot"], *perms: str) -> bool:
    """
    ...
    Parameters
    ----------
    interaction: Interaction[AmericanDexBot]
...
async def inventory_privacy(
    ...
    player: Player
        Americandex Player object of the user whose inventory is being inspected.
