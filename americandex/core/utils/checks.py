...
type Context = commands.Context["AmericanDexBot"]
...
async def get_user_for_check(bot: "AmericanDexBot", user: discord.abc.User) -> "bool | User":
    """
...
def app_check(func: "CommandsCheck[Context]"):
    ...
    Example
    -------
        from americandex.core.utils.checks import app_check, is_staff
    ...
    async def check(interaction: discord.Interaction["AmericanDexBot"]):
