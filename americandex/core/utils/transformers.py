...
parsing and validation for various Americandex models.
"""
...
log = logging.getLogger("americandex.core.utils.transformers")
...
class ModelTransformer[T: "Model"](app_commands.Transformer, commands.Converter):
    ...
    **filters: Any
    ...
    async def validate(self, ctx: commands.Context["AmericanDexBot"], item: T):
        """
    ...
    async def get_options(
        self, interaction: discord.Interaction["AmericanDexBot"], value: str
    ...
    async def transform(self, interaction: discord.Interaction["AmericanDexBot"], value: str) -> T:
        if not value:
    ...
    async def convert(self, ctx: commands.Context["AmericanDexBot"], argument: str) -> T:
        try:
...
class BallInstanceTransformer(ModelTransformer[BallInstance]):
    ...
    async def validate(self, ctx: commands.Context["AmericanDexBot"], item: BallInstance):
