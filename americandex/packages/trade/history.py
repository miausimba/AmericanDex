...
from americandex.core.utils.menus import Formatter, Menu, TextFormatter, TextSource
...
class HistoryView(LayoutView):
    def __init__(self, bot: "AmericanDexBot", trade: Trade, *, admin_view: bool = False, timeout: float | None = 180):
