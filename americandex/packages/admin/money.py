...
async def money(ctx: commands.Context[AmericanDexBot]):
    """
...
@money.command()
@checks.has_permissions("bd_models.view_player")
async def balance(ctx: commands.Context[AmericanDexBot], user: discord.User):
    """
...
async def add(ctx: commands.Context[AmericanDexBot], user: discord.User, amount: int):
    """
...
@money.command()
@checks.has_permissions("bd_models.change_player")
async def remove(ctx: commands.Context[AmericanDexBot], user: discord.User, amount: int):
    """
...
@money.command()
@checks.has_permissions("bd_models.change_player")
async def set(ctx: commands.Context[AmericanDexBot], user: discord.User, amount: int):
    """
