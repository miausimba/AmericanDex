...
async def info(ctx: commands.Context[AmericanDexBot]):
    """
...
@info.command()
async def guild(ctx: commands.Context[AmericanDexBot], guild_id: str, days: int = 7):
    """
...
@info.command()
async def user(ctx: commands.Context[AmericanDexBot], user: discord.User, days: int = 7):
    """
