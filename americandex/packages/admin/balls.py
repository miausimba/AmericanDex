...
if TYPE_CHECKING:
    ...
    from americandex.packages.countryballs.countryball import BallSpawnView

log = logging.getLogger("americandex.packages.admin.balls")
...
async def _spawn_bomb(
    ctx: commands.Context[AmericanDexBot],
...
async def balls(ctx: commands.Context[AmericanDexBot]):
    """
...
async def spawn(ctx: commands.Context[AmericanDexBot], *, flags: SpawnFlags):
    """
...
@balls.command()
@checks.has_permissions("bd_models.add_ballinstance")
async def give(ctx: commands.Context[AmericanDexBot], user: discord.User, *, flags: GiveBallFlags):
    """
...
async def balls_info(ctx: commands.Context[AmericanDexBot], countryball_id: str):
    """
...
async def balls_delete(ctx: commands.Context[AmericanDexBot], countryball_id: str, soft_delete: bool = True):
    """
...
async def balls_transfer(ctx: commands.Context[AmericanDexBot], countryball_id: str, user: discord.User):
    """
...
async def balls_reset(
    ctx: commands.Context[AmericanDexBot], user: discord.User, percentage: int | None = None, soft_delete: bool = True
):
    """
...
@checks.has_permissions("bd_models.view_ballinstance")
async def balls_count(ctx: commands.Context[AmericanDexBot], *, flags: BallsCountFlags):
    """
