...
async def logs(ctx: commands.Context[AmericanDexBot]):
    """
    Bot logs management
    """
...
@checks.has_permissions("admincmd.logs")
async def logs_add(ctx: commands.Context[AmericanDexBot], user: discord.User):
    """
...
@checks.has_permissions("admincmd.logs")
async def commandlogs_add(ctx: commands.Context[AmericanDexBot], user: discord.User):
    """
