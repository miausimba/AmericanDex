...
if TYPE_CHECKING:
    ...
    from americandex.packages.trade.cog import Trade as TradeCog
...
async def _build_history_view(
    ctx: commands.Context["AmericanDexBot"], queryset: "QuerySet[Trade]", title: str, admin_url_path: str | None = None
):
    ...
    async def callback(interaction: discord.Interaction["AmericanDexBot"]):
...
@checks.has_permissions("bd_models.view_trade", "bd_models.view_tradeobject")
async def history_user(ctx: commands.Context["AmericanDexBot"], user: discord.User, *, flags: UserTradeHistoryFlags):
    """
...
@checks.has_permissions("bd_models.view_trade", "bd_models.view_tradeobject")
async def history_ball(ctx: commands.Context["AmericanDexBot"], countryball_id: str, *, flags: TradeHistoryFlags):
    """
...
@checks.has_permissions("bd_models.view_trade", "bd_models.view_tradeobject")
async def trade_info(ctx: commands.Context["AmericanDexBot"], trade_id: str):
    """
    ...
    from americandex.packages.trade.history import HistoryView
