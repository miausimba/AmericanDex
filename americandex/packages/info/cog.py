...
from americandex import __version__ as americandex_version
from americandex.core.utils.django import row_count_estimate
...
log = logging.getLogger("americandex.packages.info")
...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction["AmericanDexBot"]):
        """
        ...
        dex_credits = (
            f"This instance is owned {owner_credits} {owner}.\nAn instance of [Americandex]"
            f"({settings.repository}) by El Laggron and maintained by the Americandex Team "
        ...
        embed.description = (
            ...
            f"*Running version **[{americandex_version}]({settings.repository}/releases)***\n"
    ...
    @app_commands.command()
    async def help(self, interaction: discord.Interaction["AmericanDexBot"]):
        """
